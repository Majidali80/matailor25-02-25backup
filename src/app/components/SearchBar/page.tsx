    ...
    const searchProducts = async () => {
      ...
      try {
        const query = `*[_type == "product" && (
          title match "*${debouncedSearch}*" ||
          productName match "*${debouncedSearch}*" ||
          category match "*${debouncedSearch}*"
        )]{
          _id,
          title,
          productName,
          ...
          <div className="p-4">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-2 pr-10 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-orange-300"
                autoFocus
              />
              {searchQuery && (
                <button
